...
def ensure_project_shape(pj: dict) -> dict:
    ...
    return {
        ...
        "tech_stack": clamp_list(pj.get("tech_stack", []), 15),  # New field: tech stack
        "project_outline": str(pj.get("project_outline", "")).strip()[:500],  # New field: project outline summary
        "implementation_phases": phases_cleaned,  # New field: detailed implementation phases
