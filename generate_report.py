...
from recommend_courses import (
    ...
    build_prompt, enforce_schema_and_rules, gaps_empty
)
...
def get_project_recommendations(job_description_text: str, resume_json: dict, job_json: dict) -> dict:
    ...
    prompt = build_project_prompt(job_description_text, resume_skills, gaps)
    ...
    cleaned = enforce_top_schema(data, required_gap_skills=flat_gaps)
    return cleaned
...
def generate_report(
    ...
    # Step 5: Get project recommendations
